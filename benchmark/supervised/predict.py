...
Unified inference: runs any of the trained models over a gold-format CSV
and writes a predictions CSV (row_id, predicted_entities_json) with char
offsets on raw_text — the format benchmark/llm/evaluate.py scores.
...
def main() -> None:
    ...
    preds = PREDICTORS[args.model](model_dir, texts, args.batch_size)
